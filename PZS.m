...
% freq_r (optional)  -> Frequency window parameters (cm-1)
                    ...
                    % 'Default' 
                    % 'single' - full maximum width of 2DIR trace at t0. 
                    % 'overlapping' - full width 50% maximum of 2DIR trace at t0.
...
% nExpDec (optional) -> single exponential decay fit (1)...
                        ... area under the curve for mutli-exponential decay fit (0)
                    % 'Default' - 1
